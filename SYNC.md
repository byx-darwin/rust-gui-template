...
- `docs/pre-commit-usage.md`, `docs/release.md`, `docs/tdd.md`

## Divergent files (intentionally different)

- `Cargo.toml` — workspace deps differ (tauri vs clap)
- `clippy.toml` — GUI uses async-first Tauri command rules
- `Makefile` — GUI-specific targets (dev, frontend, bundle)
- `apps/gui/` — Tauri + React frontend instead of CLI binary
- `docs/` — gui-patterns.md vs cli-patterns.md
